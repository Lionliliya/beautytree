          ...
          <ul class="thumbnails">
            <li class="span3">
              <a href="#" class="thumbnail"><br/>
                <img src="img/packaging/package1.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package2.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package3.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package4.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
          </ul></div>
        <h4>Подача подарка важна не меньше чем сам подарок. Выбирайте кисти у нас и мы оригинально упакуем их как
          подарок в красивенную бумагу.
          Мы вас удивим своей фантазией и экспериментами!А вы удивите дорогих вам людей таким подорочком!</h4>
        <div class="row-fluid">
          <div class="span4 offset4 btn btn-info">Цена упаковки: 35 грн</div>
        </div>
        <div class="row-fluid">
          <ul class="thumbnails">
            <li class="span3">
              <a href="#" class="thumbnail"><br/>
                <img src="img/packaging/package5.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package6.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package7.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
            <li class="span3">
              <a href="#" class="thumbnail"><br />
                <img src="img/packaging/package8.png" width="260" height="260" alt="Упаковать подарок в Киеве"><br />
              </a>
            </li>
          </ul></div>
