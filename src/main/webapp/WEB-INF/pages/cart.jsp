      ...
      <c:if test = "${cartSize gt 0}">
        ...
        <div class="row-fluid">
          <form data-persist="garlic" method="post" action="/ordering">
            ...
            <label class="radio inline">
              <input type="radio" name="delivery" id="inlineCheckbox2" value="option2" >Новая почта
            </label>
            <label class="radio inline">
              <input type="radio" name="delivery" id="inlineCheckbox2" value="option2" >УкрПочта
            </label>
            <label class="radio inline">
              <input type="radio" name="delivery" id="inlineCheckbox2" value="option2" >Курьер
            </label><br><br>
