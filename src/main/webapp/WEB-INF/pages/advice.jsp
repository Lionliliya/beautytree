...
<body>
    ...
    <div class="container" align="middle">
      ...
      <p><h2>Советы по выбору кистей для макияжа, их использованию и уходу.</h2></p>
                <p>Вопрос выбора кисточек актуальный для каждой девушки, обширный и индивидуальный. В этом посте,
                мы попробуем помочь вам с решением,      или хотя бы розьяснить неизвестные моменты.</p>
                <h4>Как выбрать кисть для макияжа.</h4>
                    <p>Раньше мы считали так: "Чем дороже, тем лучше" или "натуральный материал всегда лучше синтетики".
                      Но не всегда работает правило 	превосходства натуральных материалов для кистей над
                      синтетическими. Для некоторых косметических средств рекомендуют использование искусственных кистей
                      (для жидких тональных основ, помады).</p>
                <h4>Разновидности кистей и особенности их использования</h4>
                <h4>Уход</h4>
