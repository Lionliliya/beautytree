    ...
    <div class="container-fluid" align="middle">
      ...
      <div class="row-fluid">
        <div class="span8 offset2 block">
          <div class="textblock">Кисти для глаз</div><br>
          <p>Профессиональный отдельные косметические кисти для макияжа глаз.<br><br>Подходят как для профессионального,
            так и для домашнего использования.</p><br>
