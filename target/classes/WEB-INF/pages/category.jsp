...
<head>
    ...
    <meta lang="ru">
    <title>Beauty Tree | ${category.metaTitle}</title>
...
<div id="wrap">
    <div class="container" align="middle">
        ...
        <div class="row">
            <div class="span9"
                 style="float: none; margin-bottom: 10px; background-color: #B6A1C4; padding: 10px 5px; border-radius: 10px; color: #311838;">
                <div class="textblock"><i class="icon-heart-y"></i>${category.name}<i class="icon-heart-y"></i>
                </div>
                <br>

                <p class="description">${category.info}</p>

            </div>
        </div>

        <c:if test="${productsSize eq 0}">
            <div class="row">
                <div class="span12">
                    <article class="art-head"><h2>В данной категории пока нет товаров...</h2></article>
                </div>
                <div class="span3 offset4 cart-link"><a href="/catalog" onclick="history.back()"
                                                        style="text-decoration: none; color: inherit;">Продолжить
                    покупки &raquo;&raquo; </a></div>
            </div>
        </c:if>
