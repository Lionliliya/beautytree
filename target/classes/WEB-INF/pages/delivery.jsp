            ...
            <ul class="thumbnails">
                <li class="span3">
                    <a href="#" class="thumbnail"><br/>
                        <img src="/resources/bootstrap/img/delivery/delivery1.png" width="260" height="260" alt="Доставка и оплата"><br />
                    </a>
                </li>
                <li class="span3">
                    <a href="#" class="thumbnail"><br />
                        <img src="/resources/bootstrap/img/delivery/delivery2.png" width="260" height="260" alt="Доставка и оплата"><br />
                    </a>
                </li>
                <li class="span3">
                    <a href="#" class="thumbnail"><br />
                        <img src="/resources/bootstrap/img/delivery/delivery3.png" width="260" height="260" alt="Доставка и оплата"><br />
                    </a>
                </li>
                <li class="span3">
                    <a href="#" class="thumbnail"><br />
                        <img src="/resources/bootstrap/img/delivery/delivery4.png" width="260" height="260" alt="Доставка и оплата"><br />
                    </a>
                </li>
            </ul></div>
        <div class="hero-unit">
