...
<head>
    ...
    <meta name="keywords" content="Купить, кисть для макияжа, недорого, make-up, brush">
...
<div id="wrap">
    <div class="container" align="middle">
        ...
        <!-- List of products that fit search pattern-->
        <div class="row">
            <ul class="thumbnails">
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            <a href="/product/${product.id}" style="text-decoration: none"><img
                                    src="/resources/${product.smallimage}" width="300" height="200"
                                    alt="${product.name}"></a>
        ...
        <a href="/" class="btn btn-warning" type="button">Вернуться на главную</a>
        <br><br>
    </div>
    <div id="push"></div>
</div>
