    ...
    <div class="container" align="middle">
      ...
      <div class="row">
        <div class="span8 offset2 block">
          ...
          <p>интересные  штучки, которые помогут нам в идеальном уходе за кистями, и облегчат создания лучшего образа.</p><br>
          <p>Простые и удобные в использовании.</p>
        </div>
      </div>
      <c:if test = "${productsSize eq 0}">
        <div class="row">
          <div class="span12"><article class="art-head"><h2>В данной категории пока нет товаров...</h2></article></div>
