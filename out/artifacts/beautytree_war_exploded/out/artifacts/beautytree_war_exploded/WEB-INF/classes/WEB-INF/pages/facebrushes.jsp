    ...
    <div class="navbar navbar-fixed-top">
        <nav class="navbar-inner">
            <ul class="nav">
                ...
                <li><a href="/cart"></i>Корзина(${cartSize})</a></li>
    ...
    <div class="container" align="middle">
        ...
        <div class="row">
            <div class="span9 block" style="float: none;">
                <div class="textblock"><i class="icon-heart-y"></i>Кисти для лица<i class="icon-heart-y"></i></div><br>
                <p>Идеально подходят для нанесения основы, бронзатора или румян.
                    Подходят как для профессионального так и для домашнего использования. Простые и удобные в использовании.</p>
            </div>
        </div>
