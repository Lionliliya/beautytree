...
<!-- Top panel of navigation -->
    ...
    <div class="container" align="middle">
      <header>
        ...
        <br><div class="logo-text"><h1>BeautyTree</h1></div>
      </header>
        <div class="row">
          <div class="span9 block" style="float: none;">
            <div class="textblock"><i class="icon-heart-y"></i> Наборы кистей для макияжа<i class="icon-heart-y"></i></div><br>
            <p>Профессиональные наборы кистей высокого качества. Доступные цены. В каждом наборе есть все основные и необходимые кисточки для
              ежедневного применения. Подходит как для профессионального так и для домашнего использования.</p>
            <p>Выбирайте сами!Большой? Или компактный, который можно всегда кинуть в сумочку с собой!</p>
          </div>
        </div>
        <div class="row">
        <ul class="thumbnails">
