...
<div id="wrap">
    <div class="container" align="middle">
        ...
        <div class="row">
            <div class="span4">
                <h4 class="desc-head">Демократичные цены</h4>
                <i class="icon-heart-y"></i>

                <p class="description">Удобные make-up кисти, изготовленные из прочного бамбука и высококачественного
                    натурального и синтетического ворса. </p>

                <p><a class="price" href="/catalog">Подробнее &raquo;</a></p>
            </div>
            <div class="span4">
                <h4 class="desc-head">Подарок</h4>
                <i class="icon-heart-y"></i>

                <p class="description">Если вы не знаете, что подарить дорогой для Вас девушке или женщине, приобретайте
                    кисти для макияжа. Вы не прогадаете! </p>

                <p><a class="price" href="/catalog/2">Подробнее &raquo;</a></p>
            </div>
            <div class="span4">
                <h4 class="desc-head">Красивая упаковка</h4>
                <i class="icon-heart-y"></i>

                <p class="description">Наш товар мы доставляем в прелестных пакетиках, а по Вашему желанию мы сделаем
                    для вас стильную упаковку.</p>

                <p><a class="price" href="/packing">Подробнее &raquo;</a></p>
            </div>
        </div>
        ...
        <div id="slider" class="ideal-image-slider iis-effect-slide">
            <img src="/resources/bootstrap/img/brushset1.png" data-src-2x="/resources/bootstrap/img/brushset1.png"
                 alt="">
            <img data-src="/resources/bootstrap/img/real-gift2.png"
                 data-src-2x="/resources/bootstrap/img/real-gift2.png" src="" alt="">
            <img data-src="/resources/bootstrap/img/fur.png" data-src-2x="/resources/bootstrap/img/fur.png" src=""
                 alt="">
            <img data-src="/resources/bootstrap/img/real.png" data-src-2x="/resources/bootstrap/img/real.png" src=""
                 alt="">
            <img data-src="/resources/bootstrap/img/real-gift.png" data-src-2x="/resources/bootstrap/img/real-gift.png"
                 src="" alt="">
