...
<div class="container" align="left"><br>
  ...
  <h4><i class="icon-heart-p"></i>Добаление пользователя<i class="icon-heart-p"></i></h4>
  <div class="span10" style="float: none; margin-left: 20px; margin-bottom: 30px;">
    <form class="span10" style="float: none; margin-bottom: 60px;" method="post" action="/admin/parameters/save-new-user">

      <div class="row"><p class="label-form">Статус<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" type="text" name="role" value="Напишите статус, например: admin, manager..." required></div>
      <div class="row"><p class="label-form">Имя пользователя<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" type="text" name="username" value="" required></div>
      <div class="row"><p class="label-form">Пароль<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" id="pass1" type="password" name="password"></div>
      ...
      <div class="row"><input class="span10" type="text" name="domainName" value=""></div>
      <div class="row"><p class="label-form">Электронный адрес магазина<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" type="text" name="emailAddress" value="" required></div>

      <div class="row"><p class="label-form">Номер телефона магазина 1<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" id="phone" type="text" name="phoneNumber1" value="" required></div>
      <div class="row"><p class="label-form">Номер телефона магазина 2<i class="icon-heart-y"></i></p></div>
      <div class="row"><input class="span10" id="phone2" type="text" name="phoneNumber2" value="" required></div>
